...
//+kubebuilder:rbac:groups=cache.opentelemetry.io,resources=opentelemetryinstrumentations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.opentelemetry.io,resources=opentelemetryinstrumentations/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.opentelemetry.io,resources=opentelemetryinstrumentations/finalizers,verbs=update
